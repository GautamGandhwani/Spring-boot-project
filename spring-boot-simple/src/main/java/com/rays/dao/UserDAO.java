...
public class UserDAO {
	...
	@PersistenceContext
	public EntityManager entityManagr;

	public long add(UserDTO dto) {
		entityManagr.persist(dto);
		return dto.getId();
	}

	public void update(UserDTO dto) {
		entityManagr.merge(dto);
	}

	public void delete(UserDTO dto) {
		entityManagr.remove(dto);
	}

	public UserDTO findByPk(long pk) {
		UserDTO dto = entityManagr.find(UserDTO.class, pk);
		return dto;
	}

	public UserDTO findByUniqueKey(String attribute, String value) {

		CriteriaBuilder builder = entityManagr.getCriteriaBuilder();
		...
		TypedQuery<UserDTO> tq = entityManagr.createQuery(cq);
